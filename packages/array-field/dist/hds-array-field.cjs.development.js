...
var ArrayField = function ArrayField(props) {
  ...
  return React.createElement(react.Flex, {
    flexDir: "column",
    gap: 2
  }, label && React.createElement(react.Text, null, label), fields.map(function (item, idx) {
    var _formState$errors, _formState$errors$inp, _formState$errors$inp2, _formState$errors$inp3;
    return React.createElement(react.Flex, {
      gap: 2,
      key: item.id,
      onBlur: handleOnBlurInput,
      onChange: handleOnChangeInput
    }, React.createElement(hdsForms.InputField, Object.assign({
      id: 'input',
    ...
    })), React.createElement(react.VStack, null, React.createElement(react.Button, {
      variant: "outline",
      ...
      width: "32px",
      height: "40px"
    }, buttonRemoveChildren ? buttonRemoveChildren : React.createElement(react.Icon, {
      as: icons.DeleteIcon
    })), idx === fields.length - 1 && React.createElement(react.Button, {
      variant: "outline",
      width: "32px",
      height: "40px",
      disabled: maxValue === fields.length,
      onClick: handleAddField
    }, buttonAddChildren ? buttonAddChildren : React.createElement(react.Icon, {
      as: icons.AddIcon
    }))));
  }));
};
...
//# sourceMappingURL=hds-array-field.cjs.development.js.map
