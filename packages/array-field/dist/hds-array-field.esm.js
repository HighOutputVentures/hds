...
var ArrayFieldSchema = /*#__PURE__*/object().shape({
  input: array(object().shape({
...
var ArrayField = function ArrayField(props) {
  ...
  return React.createElement(Flex, {
    flexDir: "column",
    gap: 2
  }, label && React.createElement(Text, null, label), fields.map(function (item, idx) {
    ...
    return React.createElement(Flex, {
    ...
    })), React.createElement(VStack, null, React.createElement(Button, {
      variant: "outline",
      ...
      width: "32px",
      height: "40px"
    }, buttonRemoveChildren ? buttonRemoveChildren : React.createElement(Icon, {
      as: DeleteIcon
    })), idx === fields.length - 1 && React.createElement(Button, {
      variant: "outline",
      width: "32px",
      height: "40px",
      disabled: maxValue === fields.length,
      onClick: handleAddField
    }, buttonAddChildren ? buttonAddChildren : React.createElement(Icon, {
      as: AddIcon
    }))));
  }));
};
...
export { ArrayField };
//# sourceMappingURL=hds-array-field.esm.js.map
