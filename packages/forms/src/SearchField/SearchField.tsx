...
export default React.forwardRef<HTMLInputElement, SearchFieldProps>(function SearchField(
  props,
  ref,
) {
  const {
    ...
    <FormGroup {...others}>
      <InputGroup>
        <InputLeftElement sx={styles.leftIcon({ isDisabled: others.isDisabled })}>
          <Icon as={SearchIcon} sx={styles.icon()} data-testid="hds.search-field.icon" />
        </InputLeftElement>
