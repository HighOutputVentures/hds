...
import { Icon, HStack, Avatar } from '@chakra-ui/react';
import { FormContainer } from '@highoutput/hds-forms';
  ...
  return React.createElement(FormContainer, Object.assign({}, props), React.createElement(Select, {
    ...
    components: {
      ...
      DropdownIndicator: function DropdownIndicator(_ref) {
        ...
        var icon = selectProps.menuIsOpen ? ChevronUpIcon : ChevronDownIcon;
        return showDropdownIndicator ? React.createElement(Icon, {
          as: icon,
          w: 4,
          h: 6,
      ...
      MultiValueContainer: function MultiValueContainer(_ref2) {
        ...
        return React.createElement(chakraComponents.MultiValueContainer, Object.assign({}, props, {
          data: data
        }), React.createElement(HStack, {
          align: "center",
          spacing: "5px"
        }, data.avatar && React.createElement(Avatar, {
          width: "16px",
          height: "16px",
          src: data.avatar
        }), children));
...
//# sourceMappingURL=hds-autocomplete-input.esm.js.map
