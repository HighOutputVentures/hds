...
function HdsAvatar(props) {
  ...
  var styles = react.useMultiStyleConfig("Avatar", {
    size: size,
    variant: "hds"
  });
  return React.createElement(react.Avatar, Object.assign({
    variant: "hds",
    src: src,
    size: size,
    name: name,
    ...
    "onClick", "badgeIcon"))
  }), !!onlineIndicator /* <!-- Online Indicator --> */ && React.createElement(react.AvatarBadge, {
    role: "presentation",
    "aria-label": online ? "Online" : "Offline"
  }), !!p.verified /* <!-- Verified --> */ && React.createElement(react.Icon, {
    as: VerifiedIcon,
    role: "presentation",
    "aria-label": "Verified",
    sx: styles.verified
  }), !!p.badge /* <!-- Badge --> */ && React.createElement(react.Box, {
    role: "presentation",
...
function HdsAvatarGroup(props) {
  ...
  }, React.createElement(react.AvatarGroup, {
    variant: "hds",
    max: actualMax,
    size: size,
  ...
  })), hasAddButton && React.createElement(AddButton, {
    size: actualSize,
...
function AddButton(_ref) {
  ...
  var styles = react.useMultiStyleConfig("AvatarGroupButton", {
    size: size
  });
  return React.createElement(react.Tooltip, {
    variant: "hds-avatar",
    hasArrow: true,
    label: "Add user",
    placement: "top",
    role: "tooltip",
    "aria-label": "Add user"
  }, React.createElement(react.chakra.button, Object.assign({
    role: "button",
    "aria-label": "Add User",
    sx: styles.container
  }, props), React.createElement(react.Icon, {
    as: PlusIcon,
    sx: styles.icon
  })));
}
...
function AvatarLabel(props) {
  ...
  var styles = react.useMultiStyleConfig("AvatarLabel", {
    size: size,
    variant: "hds"
  });
  ...
  "onClick", "badgeIcon")))), React.createElement(react.Box, {
    sx: styles.label
  }, React.createElement(react.Heading, {
    sx: styles.heading
  }, name), React.createElement(react.Text, {
...
function AvatarProfile(props) {
  ...
  return React.createElement(HdsAvatar, Object.assign({
...
function withAvatar() {
  ...
  var arrowBg = react.cssVar("popper-arrow-bg");
  var Tooltip = react.defineStyleConfig({
    variants: {
...
exports.Avatar = HdsAvatar;
exports.AvatarGroup = HdsAvatarGroup;
exports.AvatarLabel = AvatarLabel;
exports.AvatarProfile = AvatarProfile;
exports.withAvatar = withAvatar;
//# sourceMappingURL=hds-avatar.cjs.development.js.map
