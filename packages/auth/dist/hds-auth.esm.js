import React__default, { createContext, createElement, useContext, useCallback, useState, useEffect } from 'react';
import cookies from 'js-cookie';
import { ViewIcon, ViewOffIcon } from '@chakra-ui/icons';
import { Box, Center, Text, Stack, Button, Heading } from '@chakra-ui/react';
import { InputField, PinInputField } from '@highoutput/hds-forms';
...
var CredentialLoginForm = function CredentialLoginForm(props) {
  ...
  return React__default.createElement(Box, {
    ...
    m: 0,
    p: 0
  }, isSignUp && signUpTitle ? signUpTitle : !isSignUp && loginTitle ? loginTitle : !isSignUp && !loginTitle ? React__default.createElement(Text, {
    size: "header-3",
    my: 8
  }, "Login") : isSignUp && !signUpTitle && React__default.createElement(Text, {
    size: "header-3",
    my: 8
  }, "Sign up")), React__default.createElement(Stack, {
    spacing: '1rem'
    ...
    disabled: formState.isSubmitting,
    rightIcon: React__default.createElement(Button, {
    ...
    type: "submit",
    my: 8
  }, isSignUp ? 'Sign Up' : 'Login'), React__default.createElement(Center, null, React__default.createElement(Text, null, isSignUp ? 'Already have an account?' : 'No account yet?', ' ', React__default.createElement(Text, {
    as: 'a',
...
var OTPForm = function OTPForm(props) {
  ...
  return React__default.createElement(Box, {
    ...
    mb: "6"
  }, title ? title : React__default.createElement(Heading, {
    as: "h1",
    mb: 2
  }, "Check your inbox"), subTitle ? subTitle : React__default.createElement(Text, null, "We have sent a 6-digit code to your email ")), React__default.createElement(PinInputField, Object.assign({
    id: "otp"
  }, registerOtp('otp'), {
...
var OTPVerificationForm = function OTPVerificationForm(props) {
  ...
  return React__default.createElement(Box, null, !otpReceived ? React__default.createElement(Box, {
    as: 'form',
  ...
  }, "Sign In")) : React__default.createElement(Box, {
...
export { AuthContext, AuthProvider, CredentialLoginForm, OTPForm, OTPVerificationForm, constants, getAuthState, logout, useAuthService, useAuthState, useProfile };
//# sourceMappingURL=hds-auth.esm.js.map
