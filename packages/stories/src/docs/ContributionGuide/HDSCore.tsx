  ...
  return (
    <ThemeProvider>
      ...
      <Text size="paragraph-md-default" mb={5}>
        Folder structure under <Code colorScheme="gray" children="./packages/hds/src" />{' '}
        folder
      </Text>
...
`}
      ...
      <Text size="paragraph-md-default" mb={5}>
        <Code colorScheme="gray" children="component" /> - under components is where the
        reusable single ui components are located, each component has a file structued
        within it
      </Text>
...
`}
      ...
      <Text size="paragraph-md-default" mb={5}>
        <Code colorScheme="gray" children="hooks" /> - you can put all the reusable hooks
        in this folder and then you can export a file from hooks into the{' '}
        <Code colorScheme="gray" children="src/index.tsx" /> file if needed.
      </Text>
...
`}
      ...
      <Text size="paragraph-md-default" mb={5}>
        <Code colorScheme="gray" children="utils" /> - this is where we save the utility
        function files that our library needed, you can also export this one in the{' '}
        <Code colorScheme="gray" children="src/index.tsx" />
      ...
      <Text size="paragraph-md-default" mb={5}>
        <Code colorScheme="gray" children="theme " /> - this is where we save the default
        design system that we setup in our library (user can overide this one)
      </Text>
...
`}
      ...
      <Text size="paragraph-md-default" mt={5} mb={5}>
        <Code colorScheme="gray" children="theme/components" /> - is where we set up
        default style of chakra ui components if we want to
      </Text>
...
`}
      ...
      <Text size="paragraph-md-default" mb={5}>
        <Code colorScheme="gray" children="colors.ts" /> - is where we setup are global
        colors that we can specify and use.
      </Text>
