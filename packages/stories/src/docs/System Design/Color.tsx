    ...
    <ThemeProvider>
      <Box>
        ...
        <Text size="paragraph-xxl-default" mb={50}>
          We use HSB to determine the brand’s primary color palette and the 100-900
          neutral colors.
        </Text>
        ...
        <Text size="paragraph-xxl-default" mb={'250px'}>
          Our brand colors distinguishes the HOV identity. The Color System is composed of
          multiple color groups: Primary brand color, The neutrals which represents our
          secondary colors, accent colors which are composed of 4 set of palettes, green,
          orange, blue, and violet, and lastly, the interface colors which represents our
          state palettes, success, errors, and warning.
        </Text>
        ...
        <Text size="paragraph-xxl-default" mb={'50px'}>
          ...
          instead of using hex to define our primary palette. It is mostly beneficial to
          standardize and define the light and dark shades of our brand primary palette.
          We need a much more comprehensive set of colors to choose from.
        </Text>
        <Text size="paragraph-xxl-default" mb={'50px'}>
          For light, we simply decrease the saturation to ~10 and increase the brightness
          to 99.
        </Text>
        <Text size="paragraph-xxl-default" mb={'100px'}>
          Then for dark, we typically leave the saturation alone and decrease the
        ...
        <Text size="paragraph-xxl-default" mt={5}>
          Use a standard value for saturation and brightness to determine our brand
          primary palettes.
        </Text>
        <Image src={'/mdx-color-assets/brand-palette.svg'} />
        <Text size="paragraph-xxl-default" mt="104px" mb={'100px'}>
          Following the 60/30/10 rule, it allow us to have a unifying criteria when
          applying our brand to UI. This rule guides us how and when to use the brand
          color palettes.
        </Text>
        ...
        <Text size="paragraph-xxl-default" mb={'64px'}>
          The 60% of the interface should be the background color 30% should be the
          typography color or texture and 10% should be the brand’s primary color.
        </Text>
        <Center w="full">
        ...
        <Text size="paragraph-xxl-default" mb={'150px'}>
          Defining the shades of HDS. Colors are intentional, has meaning, and able to
          communicate.
        </Text>
        ...
        <Text size="paragraph-xxl-default" mb={'64px '}>
          We want our brand to be recognizable. With the help of single use of color and
          repition practices, it will boost our brand identity in the system. The primary
          palette{' '}
          <Text as="span" bg="#8A68EF" width={'5px'} color="transparent" height="3px">
            sa
          </Text>
        ...
        <Text size="paragraph-xxl-default" mb={'32px '}>
          Neutral colors play as the secondary and supporting role in the interface. In
          most use cases we define neutral color scaling from 100 as the lightest to 900
          darkest.
        </Text>
        <Text size="paragraph-xxl-default" mb={'32px '}>
        ...
        <Text size="paragraph-xxl-default" mb={'32px '}>
          ...
          - I just changed the brightness and stick with the 8-grid system counting for me
          systematically determine the range.
        </Text>
        <VStack w="full" mb="150px">
          ...
          <Flex width="full" gap="80px">
            <Box p="32px 32px 25px 32px" border="1px solid #F0F0F0" borderRadius={'16px'}>
              <Text
                color="neutrals.900"
                mb="24px"
                fontSize={'32px'}
              ...
              <Text color="neutrals.500" fontSize={'16px'} lineHeight="24px">
                This is a 500 mostly text that has lowest contrast mainly use for
        ...
        <Text size="paragraph-xxl-default" mb={'48px'}>
          This set of colors will accentuate the overall brand colors and are used
          sparingly. <br /> <br /> The accent{' '}
          <Text as="span" bg="#BAEFC2" width={'5px'} color="transparent" height="3px">
            sa
          </Text>
          #BAEFC2 is used to back up and accentuate the primary. While other colors{' '}
          <Text as="span" bg="#4B5FCF" width={'5px'} color="transparent" height="3px">
            sa
          </Text>
          ##FD915B,{' '}
          <Text as="span" bg="#FD915B" width={'5px'} color="transparent" height="3px">
            sa
          </Text>
          #FD915B,{' '}
          <Text as="span" bg="#C38DF8" width={'5px'} color="transparent" height="3px">
            sa
          </Text>
          #C38DF8 are helper colors which can act as a product specification colors.{' '}
          <br /> <br />
          Accent colors are supplementary colors that typically contrast or complement the
          primary colors used in a room. Accent colors are used for emphasis, to enhance a
          color scheme, or to liven up or add drama to an otherwise monochromatic space.
          src
        </Text>
        <Center w="full">
          <Flex flexWrap={'wrap'} gap={'75px'} mb={'150px'}>
        ...
        <Text size="paragraph-xxl-default" mb={'32px '}>
          It is important to define the state colors for errors, warning, and success.
          Keeping the{' '}
          <Text size="paragraph-xxl-default" fontWeight={'bold'} as="span">
            Hue
          </Text>{' '}
          value standardized with your primary colors will be helpful with your color
          decision making. Colors describes the result of the acton taken
        </Text>
        <Text size="paragraph-xxl-default" mb={'32px '}>
