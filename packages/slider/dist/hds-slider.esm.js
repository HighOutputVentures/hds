import { useMultiStyleConfig, RangeSlider as RangeSlider$1, RangeSliderTrack, RangeSliderFilledTrack, RangeSliderThumb, Text, Slider as Slider$1, SliderTrack, SliderFilledTrack, SliderThumb } from '@chakra-ui/react';
...
var RangeSlider = /*#__PURE__*/forwardRef(function HdsRangeSlider(props, ref) {
  ...
  var styles = useMultiStyleConfig("Slider", {
    variant: "hds"
  });
  var _React$useState = useState(defaultValue || []),
    value = _React$useState[0],
    setValue = _React$useState[1];
  return createElement(RangeSlider$1, {
    variant: "hds",
    ref: ref,
    min: min,
    max: max,
    ...
    onChange: function onChange(newValue) {
      !(newValue.length === 2) ? process.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) : void 0;
  ...
  }, createElement(RangeSliderTrack, null, createElement(RangeSliderFilledTrack, null)), createElement(RangeSliderThumb, {
    index: 0
  }, labeled && labelVariant === "static" && createElement(Text, {
    sx: styles.staticLabel
  }, value[0], "%"), labeled && labelVariant === "floating" && createElement(Text, {
    sx: styles.floatingLabel
  }, value[0], "%")), createElement(RangeSliderThumb, {
    index: 1
  }, labeled && labelVariant === "static" && createElement(Text, {
    sx: styles.staticLabel
  }, value[1], "%"), labeled && labelVariant === "floating" && createElement(Text, {
    sx: styles.floatingLabel
  }, value[1], "%")));
});
var defaultProps = {
...
var Slider = /*#__PURE__*/forwardRef(function HdsSlider(props, ref) {
  ...
  return createElement(Slider$1, {
    ...
    sx: _extends({}, others, styles.container)
  }, createElement(SliderTrack, null, createElement(SliderFilledTrack, null)), createElement(SliderThumb, null, labeled && labelVariant === "static" && createElement(Text, {
    sx: styles.staticLabel
  }, value, "%"), labeled && labelVariant === "floating" && createElement(Text, {
    sx: styles.floatingLabel
  }, value, "%")));
});
var defaultProps$1 = {
...
export { RangeSlider, Slider, withSlider };
//# sourceMappingURL=hds-slider.esm.js.map
