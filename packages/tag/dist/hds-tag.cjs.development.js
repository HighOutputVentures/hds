...
var Checkbox = /*#__PURE__*/React.forwardRef(function HdsCheckbox(props, ref) {
...
function space(when, props) {
  return !when ? null : React.createElement(react.Spacer, Object.assign({
    height: "1px"
  }, props));
}
 ...
 *
 */
var Tag = /*#__PURE__*/React.forwardRef(function HdsTag(p, ref) {
  ...
  var styles = react.useMultiStyleConfig('Tag', {
    size: size,
    variant: variant
  });
  return React.createElement(react.Tag, {
    ref: ref,
    size: size,
    variant: variant,
...
//# sourceMappingURL=hds-tag.cjs.development.js.map
