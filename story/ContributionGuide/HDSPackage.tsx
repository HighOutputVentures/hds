  ...
  return (
    <ThemeProvider>
      ...
      <Text size="paragraph-md-default" mb={5}>
        In contributing for a seperate package we have slight different approach
        and files are more minimize and sizes are more light. Install first tsdx
        a zero-config cli to help us create a bare typescript packages without
        setting up anything:
      </Text>
      ...
      <Text size="paragraph-md-default" mt={5} mb={5}>
        then after installing it you can start creating a package, go to
        `./packages` under it in your terminal run command
      </Text>
      ...
      <Text size="paragraph-md-default" mt={5} mb={5}>
        ...
        <Code colorScheme="gray" children="package.json" /> file under that
        project and replace the project name to{" "}
      ...
      <Text size="paragraph-md-default" mb={5}>
        ...
        <Code colorScheme="gray" children="./packages/{package_name}/sr" />{" "}
        folder
      </Text>
...
`}
      ...
      <Text size="paragraph-md-default" mb={5}>
        <Code colorScheme="gray" children="component" /> - under components all
        the files needed for the single reusable component can be added under
        it, sample below:
      </Text>
...
`}
      ...
      <Text size="paragraph-md-default" mb={5}>
        For <Code colorScheme="gray" children="theme" /> guide you can still
        follow the document in <strong>HDS Core</strong> all custom styling
        should be under it.
      </Text>
...
`}
      ...
      <Text size="paragraph-md-default" mt={5} mb={5}>
        ...
        <Code colorScheme="gray" children="npm i lerna-cli -g" /> to run lerna
        commands.
      </Text>
    </ThemeProvider>
  );
