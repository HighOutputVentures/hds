...
const packageList = [
	...
	{
		packageLink: "https://www.npmjs.com/package/@highoutput/hds-autocomplete-inputs",
		...
		<ThemeProvider>
			<Box>
				...
				<Text size="paragraph-md-default" mb={5}>
					<strong>@highoutput/hds</strong> we aim to build a library of custom ReactJS
					components that implements our unique UI design conventions (HDS). Our
					components will be based primarily on Chakra UI. React Storybook will be used
				...
				<Text size="paragraph-md-default" mb={5}>
					In your main app file import theme provider and make it a parent of all
					components.
				</Text>
